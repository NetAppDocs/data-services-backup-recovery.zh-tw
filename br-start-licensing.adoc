...
* 如果您使用 NetApp Console 的 Backup and Recovery，您可以訂閱隨用隨付 （PAYGO） 授權，或購買自帶授權 （BYOL） 授權。
...
設定 NetApp Backup and Recovery 的授權。
...
[[use-an-annual-contract-with-marketplace-or-byol-licenses]]
=== 使用市場年度合約或 BYOL 授權
...
[[set-up-licensing-for-for-netapp-backup-and-recovery-local-deployment]]
== 設定 NetApp Backup and Recovery 本機部署的授權

設定本地部署版 NetApp Console 的授權。
...
您可以使用 NetApp Console 本機部署來管理 BYOL 授權。您可以從 Console 新增授權、更新現有授權，以及檢視授權狀態。
