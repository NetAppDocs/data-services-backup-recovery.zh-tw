...
... 若要新增新的 Hyper-V 主機，請輸入主機的 FQDN 或 IP 位址，然後選擇 Console 代理程式和認證資料。如果 Console 代理程式無法解析 FQDN，請改用 IP 位址。對於容錯移轉叢集，請輸入叢集管理 IP 位址。


.. *進階設定*：可選擇輸入 NetApp Hyper-V 外掛的安裝路徑。
