...
summary: 在使用NetApp Backup and Recovery之前，請執行幾個步驟來設定備份目標。 
---
= 在使用NetApp Backup and Recovery之前設定備份目標
:hardbreaks:
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
在使用NetApp Backup and Recovery之前，請執行幾個步驟來設定備份目標。
...
在備份目標本身配置選項後，您稍後會將其配置為NetApp Backup and Recovery中的備份目標。有關如何在NetApp Backup and Recovery中配置備份目標的詳細信息，請參閱link:br-start-discover-backup-targets.html["發現備份目標"]。
