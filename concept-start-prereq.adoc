...
| 所需軟體包  a| 
* ASP.NET Core Runtime 8.0.23 Hosting Bundle（以及所有後續的 8.0.x 修補程式）
* PowerShell 7.4.13
...
| ASP.NET Core Runtime | 8.0.23 Hosting Bundle（以及所有後續的 8.0.x 補丁） 
...
* ONTAP 9.13.1 或更新版本
* 執行 9.13.1 或更新版本的 Amazon FSx for NetApp ONTAP 儲存系統
* SAN 儲存設備（預覽）（支援從主要和次要儲存設備進行備份和還原至原始位置）
