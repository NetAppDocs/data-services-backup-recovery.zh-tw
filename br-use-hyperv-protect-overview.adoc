...
---
= 使用 NetApp Backup and Recovery 的 Hyper-V 保護工作流程
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
使用NetApp Backup and Recovery保護您的 Hyper-V 虛擬機器。NetApp Backup and Recovery。您也可以保護由 System Center Virtual Machine Manager (SCVMM) 配置並託管在 CIFS 共用上的 Hyper-V 虛擬機器。
