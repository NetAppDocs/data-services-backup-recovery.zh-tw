...
summary: 使用 NetApp 備份和復原功能保護您的 Oracle Database 工作負載。 
---
...
* 建立保護群組以管理一組資源的備份和還原作業。如需詳細資訊，請參閱 link:br-use-kvm-protection-groups.html["使用 NetApp Backup and Recovery 為 Oracle Database 工作負載建立及管理保護群組"]。
* 立即備份保護群組（立即建立按需備份）。
* 立即備份資料庫。
