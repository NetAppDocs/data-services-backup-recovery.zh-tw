...
---
= 為 NetApp Backup and Recovery 設定安全性憑證
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
如果 NetApp Backup and Recovery 容器與 StorageGRID 之間的通訊需要驗證 StorageGRID 憑證，請完成以下步驟。
...
[[steps-for-cloudmanagercbs-container]]
...
[[steps-for-cloudmanagercbscatalog-container]]
